                              ...
                              showDialog(
                                ...
                                builder: (BuildContext context) {
                                  return AlertDialog(
                                    ...
                                    content: Text('Do you want to purchase this product?'),
                                    actions: <Widget>[
                                      TextButton(
                                        child: Text('Cancel'),
                                        onPressed: () {
                                      ...
                                      TextButton(
                                        child: Text('Confirm'),
                                        onPressed: () async {
                                          // Subtract points using the purchaseManager instance
                                          await purchaseManager.subtractFromTotalPoints(productName);

                                          // Set isPurchased to true and close the dialog
                                          isPurchased = true;
                                          Navigator.of(context).pop();
                                        },
                                      ),
